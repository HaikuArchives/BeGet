...
NAME = BeGet
# Sources
SRCS=  ./src/HAddUrlDlg.cpp\
       ./src/HApp.cpp\
       ./src/HBeGetSettingView.cpp\
       ./src/HCaption.cpp\
       ./src/HListItem.cpp\
       ./src/HListView.cpp\
       ./src/HLogView.cpp\
       ...
       ./src/HSoundSettingView.cpp\
       ./src/HTaskView.cpp\
       ./src/HWGetSettingView.cpp\
       ./src/HWindow.cpp\
       ./src/PasswordWindow.cpp\
...
LOCAL_INCLUDE_PATHS = ./libs/Utils \
					./libs/Santa/\
					./libs/Toolbar\
					./libs/liblocale
OPTIMIZE= FULL
...
ifeq ($(MACHINE), BePC)
	CPU = x86
	LIBS+=stdc++.r4 ./libs/Utils/libUtils.a ./libs/Toolbar/libToolbar.a ./libs/Santa/sgb.a\
		libs/liblocale/liblocale.a
else
	CPU = ppc
	NAME = BeGet_ppc
	LIBS+=mslcpp_4_0 ./libs/Utils/libUtils_ppc.a ./libs/Toolbar/libToolbar_ppc.a\
		libs/liblocale/liblocale_ppc.a ./libs/Santa/sgb_ppc.a
endif
